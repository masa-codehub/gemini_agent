...
CONTEXT_FILE=$(uv tool run --from "git+https://github.com/masa-codehub/issue_creator_kit.git${ISSUE_KIT_REF}" ick dispatch --labels "$LABELS" --get-context || echo "UNKNOWN")
